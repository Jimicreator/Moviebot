...
##[![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=welcome+To+JimiBots!;created+by+Admin!;A+simple+autofilter+Bot!;Auto+filter+with+double+button!;start+message+with+pic!;and+all+futures!)
</p>
...
### Easy Way
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Jimicreator/Moviebot)
### Hard Way
